...
public class ITExchangeCoreIntegration extends IntegrationTestBase {
    ...
    public void before() throws InterruptedException {
        ...
        cmds.add(ApiAdjustUserBalance.builder().uid(UID_1).amount(1_000_000L).build());
        cmds.add(ApiAdjustUserBalance.builder().uid(UID_2).amount(2_000_000L).build());
    ...
    public void basicFullCycleTest() throws Exception {
        ...
        assertEquals(l2helper.build(), requestCurrentOrderBook());
    ...
    public void manyOperations() throws Exception {
        ...
        L2MarketData l2MarketData = requestCurrentOrderBook();
